...
saveCellFile([hitgenes],['hitgenes_glut2_',date,'.txt'])
...
pbino_mat(pbino_mat<1e-300) = 1e-300;
save(['pbino_glut2_',date],'pbino_mat','geneid','clusteruni')
save(['p90mat_glut2_',date],'p90_mat','geneid','clusteruni')
